...
git clone https://github.com/Lakshya312/trader-sentiment-analysis.git
...
The datasets are included in this repository. Note that the large trader dataset is compressed:


- Bitcoin Sentiment: fear_greed_index.csv (Ready to use).

- Trader Data: historical_data.csv.zip (Please unzip this file into the main folder before running the notebook).

### 4. Launch the Analysis
Start the Jupyter environment to view the methodology and results:
